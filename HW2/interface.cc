/*********************************************************************
  ...
  Last updated:  September 10, 2015 - Hunter Johnson
...
void printMenu ()
{
	...
	cout << "16) Compute the sum of all numbers in the first list.\n";
	cout << "17) Return element at a given position in the first list.\n";
...
bool carryOutTheAction (int choice, List & first, List & second)
{
    ...
    case 15:
        ...
        first.print();
	case 16:
	    cout << "The sum of the first list is: " << first.sum() << endl;
        break;
	case 17:
	    nodeAtPositionAction(first);
		break;
	case 18:
	    locateAction(first);
		break;
...
void nodeAtPositionAction(List &first)
{
  ListIterator iter;
  int index;

  cout << "\nEnter the index of the element in the first list: ";
  cin >> index;
  while ( !cin.good() ) 
      {
          cout << "\nAn integer number is required.\n"
  ...
  iter = first.nodeAtPosition(index);

  if (iter)
      cout << "The value of element " << index << " is " << *iter << ".\n";

  else
      cout << "There is no element at postion " << index << ".\n";

  while (cin.get() != '\n');  // Clear the line
}

// locate given number within a list
void locateAction(List &first)
{
  ListIterator iter;
  int num;

  cout << "\nEnter the number to locate in the first list: ";
  cin >> num;
  while ( !cin.good() ) 
      {
          cout << "\nAn integer number is required.\n"
  ...
  iter = first.locate(num);

  if (iter)
      cout << "The number " << *iter << " is in the first list.\n";
  
  else     
      cout << "The number "<< num << " is not in the first list.\n";
